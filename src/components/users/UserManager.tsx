    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
        ...
        <button
          ...
          className="px-4 py-2 bg-sky-600 hover:bg-sky-700 text-white rounded-xl text-xs font-bold shadow-md shadow-sky-600/20 flex items-center gap-1.5 transition cursor-pointer"
        >
      ...
      <div className="p-4 bg-gradient-to-r from-sky-50 via-blue-50 to-sky-50 rounded-2xl border border-sky-200 shadow-xs flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
        <div>
          <h4 className="text-xs font-extrabold text-sky-900 flex items-center gap-2">
            <Clock className="w-4 h-4 text-sky-600" /> Pengaturan Batas Durasi Sesi Praktikum Operator
          </h4>
            ...
            {usersList.map((u) => {
              ...
              return (
                <tr key={`${u.id}-${u.email}`} className="hover:bg-slate-50/80 transition">
                  ...
                  <td className="p-3">
                    <span className={`px-2.5 py-0.5 rounded-full text-[10px] font-extrabold uppercase border ${u.role === 'admin'
                  ...
                  <td className="p-3">
                    {u.isScheduleRestricted ? (
                      <div className="flex flex-col gap-0.5">
                        <span className="px-2.5 py-0.5 bg-sky-50 text-sky-800 border border-sky-200/80 rounded-lg text-[10.5px] font-bold inline-flex items-center gap-1 w-fit">
